<template>
  <div id="app">
    <div class="div_border" style="width: 1500px;height:400px;margin: 20px;">
      <button @click="clusters_show">clusters_show</button>
        <div id="View1" style="overflow-y: auto ;width: 100%;height: 300px;margin-top: 50px;">
            <div class="scroll_div" v-for="cluster in clusters" :key="cluster.id">
                <div class="info_div">
                    <div>cluster:</div><div>{{ cluster.id }}</div>
                    <br/>
    ...
    <div class="div_border" style="position: relative;width: 1058px;height:400px;margin: 20px;">
        <div class="childContainer" style="width: 80%;height: 60%;">
...
//   import axios from 'axios'
  ...
  export default {
    ...
    methods:{
            ...
            fetch('http://127.0.0.1:5000/data')
                ...
                .then(data => {
                    ...
                    for(let key in data){
                        ...
                        for(let i=0;i<10;i++){
                            this.fetch_images(key, data[key]['images'][i]);
                        }
                        // for(let i=0;i<10;i++){
        ...
        async fetch_images(key, image_name){
            var that = this;
            await fetch('http://127.0.0.1:5000/images/' + image_name)
